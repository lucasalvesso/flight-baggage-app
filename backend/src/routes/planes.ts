...
import { handler as GetAllHandler } from "../handlers/planes/GetAll";
import { handler as PostHandler } from "../handlers/planes/Post";
import { handler as DeleteHandler } from "../handlers/planes/Delete";
